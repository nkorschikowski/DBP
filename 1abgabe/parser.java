...
public class dynamicXML {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (Connection conn = DriverManager.getConnection(url, name, password)) {
            ...
            InputStream inputStream = new FileInputStream(xmlLeipzig); // <-- Data input
                    ...
                    switch(tag){
                        ...
                        case "tracks":
                            while (reader.hasNext()) {
                                ...
                                if (event.isStartElement() && event.asStartElement().getName().getLocalPart().equals("tracks")) {
                                    while (reader.hasNext()) {
                                        event = reader.nextEvent();

                                        // Read each <title> inside <tracks>
                        ...
                        case "publication":
                            ...
                            erscheinungsdatum = LocalDate.parse((attr != null) ? attr.getValue() : "");
    ...
    private static boolean isTable(Connection conn, String tag) throws SQLException {
        /*return Set.of("produkte", "buecher", "dvds", "musikcds", "titel", "personen",
                ...
                "adressen", "angebote", "kunden", "kauf", "kauf_produkt", "rezensionen").contains(tag);*/
