...
public class DVDPersonId implements Serializable {
    private String produkt_nr;  
    private int person_id;   

    public DVDPersonId() {}

    public DVDPersonId(String produkt_nr, int person_id) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DVDPersonId)) return false;
        DVDPersonId that = (DVDPersonId) o;
